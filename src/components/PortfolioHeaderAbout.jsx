...
const PortfolioHeaderAbout = ({ className = "" }) => {
  return (
    <section
      className={`self-stretch overflow-hidden flex flex-col items-center justify-center py-0 px-space-2400 text-left text-37xl text-delft-blue font-text-regular-normal ${className}`}
    >
      <div className="self-stretch flex flex-row items-start justify-center py-20 px-0">
        <div className="flex-1 flex flex-col items-start justify-center gap-[80px]">
          <div className="self-stretch flex flex-row flex-wrap items-center justify-center gap-[80px]">
            <div className="flex-1 box-border flex flex-col items-start justify-center py-9 px-0 gap-[36px] min-w-[224px] border-b-[1px] border-solid border-sapphire">
              ...
              <div className="self-stretch box-border flex flex-row items-start justify-center py-0 pr-4 pl-0 min-w-[224px] text-lg border-r-[1px] border-solid border-sapphire">
            ...
            <div className="w-[405px] h-[327px] flex flex-col items-start justify-center">
            <img
  ...
  alt="Your Image"
          ...
          <div className="self-stretch flex flex-col items-start justify-center gap-[80px] text-xl">
            <div className="self-stretch flex flex-row flex-wrap items-start justify-center py-4 px-0 gap-[24px_64px] border-b-[1px] border-solid border-sapphire">
              <div className="w-[373px] flex flex-row items-center justify-center py-0 px-24 box-border gap-[24px] min-w-[304px]">
              ...
              <div className="w-[374px] box-border flex flex-col items-center justify-center py-0 px-24 gap-[24px] min-w-[304px] border-r-[1px] border-solid border-sapphire border-l-[1px]">
              ...
              <div className="flex-1 flex flex-col items-center justify-center py-0 px-24 box-border gap-[24px] min-w-[304px]">
            ...
            <div className="self-stretch flex flex-row flex-wrap items-start justify-center gap-[24px_16px] border-b-[1px] border-solid border-sapphire">
              <div className="flex-1 box-border flex flex-col items-start justify-center pt-0 pb-4 pr-4 pl-0 gap-[24px] min-w-[200px] border-r-[1px] border-solid border-sapphire">
                <div className="self-stretch relative leading-[150%] font-extrabold">
                  Experience:
                </div>
              ...
              <div className="flex-1 flex flex-col items-start justify-center pt-0 px-4 pb-4 box-border gap-[24px] min-w-[200px]">
                <div className="self-stretch relative leading-[150%] font-extrabold">
