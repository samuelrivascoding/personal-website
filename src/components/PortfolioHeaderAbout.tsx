...
export type PortfolioHeaderAboutType = {
  className?: string;
};

const PortfolioHeaderAbout: FunctionComponent<PortfolioHeaderAboutType> = ({
  className = "",
}) => {
  return (
    <section
        ...
        <div className="flex-1 flex flex-col items-start justify-start gap-[80px]">
          <div className="self-stretch flex flex-row flex-wrap items-center justify-center gap-[80px]">
            ...
            <div className="w-[405px] h-[327px] flex flex-col items-start justify-start">
              <div className="w-[300px] relative shadow-[0px_4px_4px_rgba(0,_0,_0,_0.25)] rounded-17xl bg-gray box-border h-[300px] border-[24px] border-solid border-periwinkle" />
            </div>
          </div>
